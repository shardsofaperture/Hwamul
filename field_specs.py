...
TABLE_SPECS: dict[str, dict[str, FieldSpec]] = {
    ...
    "pack_rules": {
        ...
        "dim_l_cm": FieldSpec("decimal", required=True, min_value=0.01, description="Pack length in centimeters (legacy meter values also accepted)", example="120", notes="Use centimeters for pallet/cargo uploads using individual handling units (e.g., 120). Legacy meter values (e.g., 1.20) are still accepted."),
        "dim_w_cm": FieldSpec("decimal", required=True, min_value=0.01, description="Pack width in centimeters (legacy meter values also accepted)", example="80", notes="Use centimeters for pallet/cargo uploads using individual handling units (e.g., 80). Legacy meter values (e.g., 0.80) are still accepted."),
        "dim_h_cm": FieldSpec("decimal", required=True, min_value=0.01, description="Pack height in centimeters (legacy meter values also accepted)", example="90", notes="Use centimeters for pallet/cargo uploads using individual handling units (e.g., 90). Legacy meter values (e.g., 0.90) are still accepted."),
