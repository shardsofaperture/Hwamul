...
TABLE_SPECS: dict[str, dict[str, FieldSpec]] = {
    ...
    "pack_rules": {
        ...
        "dim_l_m": FieldSpec("decimal", required=True, min_value=0.01, description="Pack length (cm preferred; m also accepted)", example="120", notes="Use centimeters for pallet/crate uploads (e.g., 120). Meter values (e.g., 1.20) are still accepted."),
        "dim_w_m": FieldSpec("decimal", required=True, min_value=0.01, description="Pack width (cm preferred; m also accepted)", example="80", notes="Use centimeters for pallet/crate uploads (e.g., 80). Meter values (e.g., 0.80) are still accepted."),
        "dim_h_m": FieldSpec("decimal", required=True, min_value=0.01, description="Pack height (cm preferred; m also accepted)", example="90", notes="Use centimeters for pallet/crate uploads (e.g., 90). Meter values (e.g., 0.90) are still accepted."),
