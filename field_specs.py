...
TABLE_SPECS: dict[str, dict[str, FieldSpec]] = {
    ...
    "pack_rules_import": {
        ...
        "length_cm": FieldSpec("decimal", required=True, min_value=0.1, description="Pack length in centimeters", example="120", notes="Converted to meters for storage (cm / 100). Legacy length_mm input is accepted and converted to cm automatically."),
        "width_cm": FieldSpec("decimal", required=True, min_value=0.1, description="Pack width in centimeters", example="80", notes="Converted to meters for storage (cm / 100). Legacy width_mm input is accepted and converted to cm automatically."),
        "height_cm": FieldSpec("decimal", required=True, min_value=0.1, description="Pack height in centimeters", example="90", notes="Converted to meters for storage (cm / 100). Legacy height_mm input is accepted and converted to cm automatically."),
        ...
        "plant_code": FieldSpec("text", max_length=40, regex=r"^[A-Z0-9_.-]{2,40}$", allowed_chars="A-Z, 0-9, ., _, -", description="Optional material plant code for the SKU; defaults to UNSPECIFIED when omitted", example="US_TX_DAL"),
        "uom": FieldSpec("text", max_length=16, regex=r"^[A-Z]{1,16}$", allowed_chars="A-Z", description="Optional default SKU unit of measure used by BOM quantity rows", example="KG"),
        "default_coo": FieldSpec("text", max_length=2, regex=r"^[A-Z]{2}$", allowed_chars="A-Z", description="Optional default country of origin for customs; defaults to UN when omitted", example="CN"),
    ...
    "raw_bom_import": {
        ...
        "raw_qty": FieldSpec("decimal", min_value=0.001, description="Requested raw quantity before pack rounding (interpreted in SKU default UOM)", example="250"),
        "raw_weight_kg": FieldSpec("decimal", min_value=0.001, description="Optional required gross weight in kilograms; use when quantity is unknown", example="1250"),
